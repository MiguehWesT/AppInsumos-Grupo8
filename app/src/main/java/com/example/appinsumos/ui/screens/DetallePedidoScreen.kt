                ...
                Card(
                    ...
                    Column(
                        ...
                        TimelineItem(
                            ...
                            completado = true,
                            fecha = "${pedido.fecha} - 08:30"
                        )

                        TimelineItem(
                            estado = EstadoPedido.EN_PREPARACION,
                            completado = pedido.estado != EstadoPedido.PENDIENTE,
                            fecha = "${pedido.fecha} - 10:15"
                        )

                        TimelineItem(
                            estado = EstadoPedido.EN_REPARTO,
                            completado = pedido.estado == EstadoPedido.EN_REPARTO || pedido.estado == EstadoPedido.ENTREGADO,
                            fecha = "${pedido.fecha} - 14:20",
                            actual = pedido.estado == EstadoPedido.EN_REPARTO
                        )

                        TimelineItem(
                            estado = EstadoPedido.ENTREGADO,
                            completado = pedido.estado == EstadoPedido.ENTREGADO,
                            fecha = "Estimado: Próximo día hábil",
                            actual = pedido.estado == EstadoPedido.ENTREGADO
                        )
                    }
                }
                ...
                Card(
                    ...
                    Box(
                        ...
                        Column(
                            ...
                            Text(
                                text = if (pedido.estado == EstadoPedido.EN_REPARTO)
                                    "El repartidor está en camino"
                                else
                                    "Disponible cuando esté en reparto",
                                fontSize = 12.sp,
